...
namespace ProjetJulietteJeremyMailys
{
    class FonctionsMatieres
    {
        public static Matieres CreerMatiere()
        {
            ...
            p.Code = FonctionsUtilisateurs.DemandeEntier("Quel est le code de la matière ?");

            // demander le nombre d'heures de la matière
            p.Nbheures = FonctionsUtilisateurs.DemandeEntier("Quel est le nombre d'heures de la matière ?");
